...
class DoiResolverSpec extends FlatSpec with Matchers {
  ...
  "dfa_boundary" should "validate ..." in {
    ...
    dfaRun.filter("""<SENT sid="34" pm="."><plain>omim <z:acc db="omim" valmethod="onlineWithContext" domain="omim" context="(?i)(o*mim)" wsize="20" sec="XXXX">603878</z:acc></plain></SENT>""") should be ("""<SENT sid="34" pm="."><plain>omim <z:acc db="omim" ids="603878">603878</z:acc></plain></SENT>""")
    //
    dfaRun.filter("""<text><SENT sid="34" pm="."><plain>omim <z:acc db="omim" valmethod="onlineWithContext" domain="omim" context="(?i)(o*mim)" wsize="20" sec="XXXX">603878</z:acc></plain></SENT></text>""") should be ("""<text><SENT sid="34" pm="."><plain>omim <z:acc db="omim" ids="603878">603878</z:acc></plain></SENT></text>""")
    //
    dfaRun.filter("""<article><text><SENT sid="34" pm="."><plain>omim <z:acc db="omim" valmethod="onlineWithContext" domain="omim" context="(?i)(o*mim)" wsize="20" sec="XXXX">603878</z:acc></plain></SENT></text></article>""") should be ("""<article><text><SENT sid="34" pm="."><plain>omim <z:acc db="omim" ids="603878">603878</z:acc></plain></SENT></text></article>""")
    //
    dfaRun.filter("""<SecTag type="TABLE"><text><SENT sid="34" pm="."><plain>omim <z:acc db="omim" valmethod="onlineWithContext" domain="omim" context="(?i)(o*mim)" wsize="20" sec="XXXX">603878</z:acc></plain></SENT><SENT sid="35" pm="."><plain><z:acc db="omim" valmethod="onlineWithContext" domain="omim" context="(?i)(o*mim)" wsize="2000" sec="XXXX">603878</z:acc></plain></SENT></text></SecTag>""") should be ("""<SecTag type="TABLE"><text><SENT sid="34" pm="."><plain>omim <z:acc db="omim" ids="603878">603878</z:acc></plain></SENT><SENT sid="35" pm="."><plain><z:acc db="omim" ids="603878">603878</z:acc></plain></SENT></text></SecTag>""")
    //
